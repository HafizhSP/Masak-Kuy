...
public class bahanlauk_resep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pilihanResep.equalsIgnoreCase("Ayam Kecap")){
            ...
            penjelasanLauk.setText("Ayam kecap adalah sebuah hidangan ayam yang berasal dari Asia Tenggara Maritim yang dibumbui dengan kecap manis.");
            ...
            penjelasanLauk.setText("Ayam suwir adalah salah satu olahan daging ayam yang praktis dan antiribet untuk dibuat. Ayam suwir merupakan hidangan kering yang tidak hanya cocok disantap di rumah, tapi praktis dibawa ke mana-mana.");
            ...
            penjelasanLauk.setText("Resep ayam rica-rica ini dikenal berasal dari daerah Manado, Sulawesi Utara yang memiliki cita rasa pedas dan enak.");
            ...
            penjelasanLauk.setText("Ayam goreng gurih ini juga merupakan salah satu resep masakan rumahan yang digemari anak-anak hingga orang tua. Rasanya yang lezat menjadikan makanan tersebut bisa dimakan dalam segala suasana, baik untuk sarapan, makan siang ataupun makan malam.");
            ...
            penjelasanLauk.setText("Betutu adalah lauk yang terbuat dari ayam atau bebek yang utuh yang berisi bumbu, kemudian dipanggang dalam api sekam. Betutu ini telah dikenal di seluruh kabupaten di Bali.");
            ...
            penjelasanLauk.setText("Telur Kecap merupakan makanan sederhana yang waktu penyajiannya relatif cepat, itu dikarenakan hanya menggabungkan beberapa bahan saja. Jadi, Telur Kecap ini merupakan makanan andalamn orang orang yang malas gerak.");
            ...
            penjelasanLauk.setText("Tahu mercon yaitu tahu goreng yang diisi sambel ,sehingga saat orang menggigit tahu tersebut , dimulut seakan meledak karena pedasnya sambel.");
            ...
            penjelasanLauk.setText("Ikan Bumbu Kuning adalah salah satu hidangan khas Maluku. Kuah kuning dan rasa asamnya diperoleh dari santan yang dibumbui macam-macam rempah.");
            ...
            penjelasanLauk.setText("Daging lada hitam adalah hidangan istimewa yang bukan hanya lezat namun juga bisa dimanfaatkan untuk meningkatkan imunitas tubuh secara alami.");
            ...
            penjelasanLauk.setText("Udang balado adalah olahan dari udang yang ditambahkan dengan bumbu balado sehingga mempunyai rasa yang nikmat dan disukai oleh semua kalangan.");
            ...
            penjelasanLauk.setText("Cumi-cumi merupakan seafood yang paling digemari di dunia karena rasa dan teksturnya yang unik.");
            ...
            penjelasanLauk.setText("Tempe Penyet adalah makanan khas Indonesia dari daerah Jawa Timur. Makanan ini dibuat dari tempe yang direndam di air kaldu dengan bumbu garam dan ketumbar. Tempe tersebut kemudian digoreng dan setelah masak disajikan dengan sambal.");
