...
public class bahansayur_resep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pilihanResep.equalsIgnoreCase("Sop Wortel")){
            ...
            penjelasanSayur.setText("adalah sebuah sup yang disajikan dengan wortel sebagai bahan utama. Hidangan ini dapat disajikan sebagai sup berkaldu atau krim. Sayur tambahan, sayur akar dan berbagai bahan lain dapat dipakai dalam penyajiannya");
            ...
            penjelasanSayur.setText("Nugget Wortel adalah Nugget yang dicampur dengan sayuran berbahan utama wortel, kaya gizi dengan kandungan murni daging ayam. Diberi racikan bumbu alami. Dan dibalut tepung roti renyah.");
            ...
            penjelasanSayur.setText("Udah pada familiar belum nih sama wortel goreng? Sama seperti terong, jamur, dan lain-lain, wortel pun bisa digoreng. Olahan ini cocok dimakan bersama dengan nasi sebagai lauk. Berikut adalah resep wortel goreng");
            ...
            penjelasanSayur.setText("kroket adalah gumpalan kentang tumbuk halus berisi daging cincang yang dibumbui dan dicampur dengan sayuran seperti wortel atau buncis. Kroket dilumuri kocokan telur dan tepung panir sebelum digoreng di dalam minyak goreng yang banyak.");
            ...
            penjelasanSayur.setText("Tumis Wortel adalah sebutan umum untuk masakan yang dibuat dengan proses menggoreng dengan sedikit minyak atau ditumis sambil diaduk-aduk sampai matang atau dalam bahasa Inggris disebut Stir-Fried dan menggunakan bahan dasar wortel.");
            ...
            penjelasanSayur.setText("Jagung muda, baby corn, atau ada yang menyebutnya putren, adalah sayuran yang enak, rasanya manis, teksturnya ‘garing’, kaya serat, dan memiliki kadar zat tepung (starch) lebih rendah dibandingkan jagung yang sudah dewasa sehingga lebih rendah karbohidrat.");
            ...
            penjelasanSayur.setText("Selain sawi hijau, tumis sawi putih juga bisa jadi menu masakan andalan untuk keluarga di rumah. Memasaknya mudah dan cepat. Untuk mendapatkan rasa tumis sawi putih yang enak, kamu bisa menambahkan dengan beberapa bumbu seperti bawang putih, bawang merah, lada, irisan cabai dan saus tiram.");
            ...
            penjelasanSayur.setText("Resep Olahan Brokoli yang enak dan lezat");
            ...
            penjelasanSayur.setText("Kangkung memiliki kandungan mineral, vitamin A, B, C, asam amino, zat besi, fosfor, karoten, dan kalsium. Karena berbagai kandungannya itulah, kangkung memiliki sifat anti racun, peluruh, perdarahan, diuretic (pelancar kencing), anti radang dan sedatif");
            ...
            penjelasanSayur.setText("Sayur Tumis Bayam adalah tumis sayur-sayuran segar yang biasa dikonsumsi oleh masyarakat Indonesia.  Sayur Tumis Bayam mengandung energi sebesar 193 kilokalori, protein 2 gram, karbohidrat 0 gram, lemak 0 gram, kalsium 191,9 miligram, fosfor 0 miligram, dan zat besi 2,8 miligram.");
            ...
            penjelasanSayur.setText("Jamur adalah salah satu bahan makanan yang sangat mudah diolah dan dipercaya dapat menurunkan resiko kanker.");
            imgResep.setImageResource(R.drawable.tumis_jamur);
        } else if (pilihanResep.equalsIgnoreCase("Balado Terung")){
            ...
            penjelasanSayur.setText("Terong balado adalah hidangan Minangkabau yang berupa terong dimasak dengan bumbu cabai merah balado yang pedas.");
